...
public class Lab6 extends GLJPanel implements GLEventListener  {
	...
	public static void main(String[] args) {
		JFrame window = new JFrame("Figura");
		Lab6 panel = new Lab6();
	...
	public void display(GLAutoDrawable drawable) {    
	  ...
	  public void Rysuj(GL2 gl2,int n){
	        ...
	        for (int i = 1; i <= n; i++) {
	            ...
	            gl2.glMaterialfv (GL2.GL_FRONT, GL2.GL_DIFFUSE, materials[i], i);
	            ...
	            gl2.glMaterialfv(GL2.GL_FRONT, GL2.GL_AMBIENT_AND_DIFFUSE, materials[1],i);
	...
	public void init(GLAutoDrawable drawable) {
		...
		//gl2.glEnable(GL2.GL_LIGHT3);
		 float[] ambientLevel = { 0.8f, 0.4f, 0.8f, 1f };
